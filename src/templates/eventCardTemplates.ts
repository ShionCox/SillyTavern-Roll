...
export function buildEventRolledBlockTemplateEvent(
  rolledPrefixHtml: string,
  summaryHtml: string
): string {
...
export function buildEventRollButtonTemplateEvent(
  params: EventRollButtonTemplateParamsEvent
): string {
...
export function buildEventDistributionBlockTemplateEvent(
  rollsHtml: string,
  modifierHtml: string
): string {
  return `
